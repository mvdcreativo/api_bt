...
class PermissionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        //Etapas
        Permission::create(['name' => 'evolution.index', 'description' => 'Listar Evoluciones', 'guard_name' => 'api']);
        Permission::create(['name' => 'evolution.create', 'description' => 'Crear Evoluciones', 'guard_name' => 'api']);
        Permission::create(['name' => 'evolution.show', 'description' => 'Ver datos de un Evolución', 'guard_name' => 'api']);
        Permission::create(['name' => 'evolution.update', 'description' => 'Actualizar datos de un Evolución', 'guard_name' => 'api']);
        Permission::create(['name' => 'evolution.delete', 'description' => 'Eliminar Evoluciones', 'guard_name' => 'api']);
        ...
        $roleSAdmin->syncPermissions([
            ...
            'evolution.index', 'evolution.show', 'evolution.create', 'evolution.update', 'evolution.delete',
        ]);
    }
}
